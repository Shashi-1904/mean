...
export class AdminService {
  ...
  private apiUrl = 'http://localhost:4200/api/student/';
  ...
  boysSuperDeluxRooms() {
    return this.httpClient.get<any>(`http://localhost:4200/api/boysRooms/superDeluxeRooms`).pipe
    (
      switchMap(({ total }) => {
        return of(total);
      }),
  ...
  boysDeluxRooms() {
    return this.httpClient.get<any>(`http://localhost:4200/api/boysRooms/deluxeRooms`).pipe
    (
      switchMap(({ total }) => {
        return of(total);
      }),
  ...
  boysStandardRooms() {
    return this.httpClient.get<any>(`http://localhost:4200/api/boysRooms/standardRooms`).pipe
    (
      switchMap(({ total }) => {
        return of(total);
      }),
  ...
  girlsSuperDeluxRooms() {
    return this.httpClient.get<any>(`http://localhost:4200/api/girlsRooms/superDeluxeRooms`).pipe
    (
      switchMap(({ total }) => {
        return of(total);
      }),
  ...
  girlsDeluxRooms() {
    return this.httpClient.get<any>(`http://localhost:4200/api/girlsRooms/deluxeRooms`).pipe
    (
      switchMap(({ total }) => {
        return of(total);
      }),
  ...
  girlsStandardRooms() {
    return this.httpClient.get<any>(`http://localhost:4200/api/girlsRooms/standardRooms`).pipe
    (
      switchMap(({ total }) => {
        return of(total);
      }),
  ...
  findHostelPriceDetails() {
    return this.httpClient.get<any>(`http://localhost:4200/api/prices/findHostelPriceDetails`).pipe
    (
      switchMap(({ price }) => {
  ...
  updatePriceDetails(priceDetails: any) {
    return this.httpClient.post<any>(`http://localhost:4200/api/prices/updatePriceDetails`,priceDetails)
    .pipe(
      switchMap(({ msg }) => {
        return of(msg);
      }),
  ...
  getAllUsers() {
    return this.httpClient.get<any>(`http://localhost:4200/api/users/AllUser`).pipe
    (
      switchMap(({ users }) => {
        return of(users);
      }),
  ...
  updateUser(user: any) {
    return this.httpClient.post<any>(`http://localhost:4200/api/users/userUpdate`,user)
    .pipe(
      switchMap(({ msg }) => {
        // console.log(msg);
        return of(msg);
